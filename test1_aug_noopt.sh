...
CUDA_VISIBLE_DEVICES=0 python train.py --lr 3e-3 --bs 64 --epochs 400  --save_path ./results/test1_aug_noopt/avae_modelnet_10class_noaug_noopt_l32 --model_type avae3d --n_classes 10 --data_augmentation none --opt_method none  --latent_size 322
